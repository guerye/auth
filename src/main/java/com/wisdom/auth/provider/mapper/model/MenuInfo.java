...
public class MenuInfo implements Serializable,Cloneable {
     ...
     */
    @Transient
    private List<com.wisdom.auth.provider.mapper.model.MenuInfo> children;
    /**
     * 菜单里按钮
     */
    @Transient
    ...
    public List<com.wisdom.auth.provider.mapper.model.MenuInfo> getChildren() {
        return children;
    }

    public void setChildren(List<com.wisdom.auth.provider.mapper.model.MenuInfo> children) {
