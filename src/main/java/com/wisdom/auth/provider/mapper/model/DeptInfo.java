...
public class DeptInfo implements Serializable,Cloneable {
     ...
     * 下级部门
     */
    private List<com.wisdom.auth.provider.mapper.model.DeptInfo> children;
    ...
    public List<com.wisdom.auth.provider.mapper.model.DeptInfo> getChildren() {
        return children;
    }

    public void setChildren(List<com.wisdom.auth.provider.mapper.model.DeptInfo> children) {
